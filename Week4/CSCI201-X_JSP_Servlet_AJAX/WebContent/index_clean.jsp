...
<div class="bloc l-bloc none " id="demobody">
	<div class="container bloc-md">
		<div class="row">
			<div class="col-md-6">
				<form id="form_1" data-form-type="blocs-form">
					...
					<div class="form-group" id="formemail">
						...
						<input id="email" name="emailInput" class="form-control" type="email" data-error-validation-msg="Not a valid email address" required />
					</div>
					<div class="form-group" id="formmsg">
						<label>
							Message
						</label><textarea id="message" name="messageInput" class="form-control" rows="4" cols="50" required></textarea>
					</div>
			...
			<div class="col-md-6">
				...
				</div><a class="btn btn-d btn-lg btn-clean btn-block" id="searchbutton"><span class="feather-icon icon-search"></span></a>
			</div>
		</div>
	</div>
</div>
